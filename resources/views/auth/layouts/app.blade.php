...
{{--                            </li>--}}
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('settings_site.index') }}"><b>Настройки</b></a>
                            </li>
                            <li class="nav-item">
...
{{--                            </li>--}}
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('gallery.index') }}">Наши работы</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('formOrder.index') }}">Заказанные товары</a>
                            </li>
                            <li class="nav-item">
                                <a class="btn btn-primary" href="{{ route('product.convert-rub-to-usd') }}">Запустить конвертер цен</a>
                            </li>
                        </ul>
                        @endauth
