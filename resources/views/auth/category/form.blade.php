                    ...
                    <div class="card-header">
                        ...
                        @isset($category)
                            <a target="_blank" class="btn btn-success btn-sm mr-5"
                               href="{{route('category_site.index', $category->url)}}"><i class="fas fa-eye mr-2"></i>Просмотреть
                                категорию</a>
                            <a class="btn btn-primary btn-sm float-right" href="{{route('category.create')}}">Создать
                                категорию</a>
                        @endisset
                                        ...
                                        <div class='col-xl-6'>
                                            <div class='form-group'>
                                                ...
                                                <input class='form-control' type='text' name='position'
                                                       value='{{old('position', isset($category)? $category->position: 0)}}'>
                                            </div>
                                        </div>
                                        <div class='col-xl-6'>
                                            <div class='form-group'>
                                                ...
                                                <input class='form-control' type='text' name='per_page'
                                                       value='{{old('per_page', isset($category)? $category->per_page: 10)}}'>
                                            </div>
                                        </div>
                                        ...
                                        <div class='col-xl-6'>
                                            <div class='form-group'>
                                                ...
                                                <select class='form-control' name='sort'>
                                                    ...
                                                    @if(isset($category) && $category->sort == 1) selected="selected"
                                                        @endif
                                                    ...
                                                    @if(isset($category) && $category->sort == 2) selected="selected"
                                                        @endif
                                                        value='2'>Алфавиту
                                                    </option>
                                                    ...
                                                    @if(isset($category) && $category->sort == 3) selected="selected"
                                                        @endif
                                                        value='3'>Позиции
                                                    </option>
                                                </select>
                                        ...
                                        <div class='col-xl-6'>
                                            <div class='form-group'>
                                                ...
                                                <select class='form-control' name='sort_order'>
                                                    ...
                                                    @if(isset($category) && $category->sort_order == 1) selected="selected"
                                                        @endif
                                                    ...
                                                    @if(isset($category) && $category->sort_order == 2) selected="selected"
                                                        @endif
                                ...
                                <div class="tab-pane fade show active" id="content" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <input
                                                    ...
                                                    type="text"
                                                    value='{{old('meta_tag_title', isset($category)? $category->meta_tag_title: null)}}'
                                                    name="meta_tag_title">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text"
                                                       value='{{old('meta_tag_description', isset($category)? $category->meta_tag_description: null)}}'
                                        ...
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text"
                                                       value='{{old('meta_tag_keywords', isset($category)? $category->meta_tag_keywords: null)}}'
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                       ...
                                                       name="url"
                                                       value='{{old('url', isset($category)? $category->url: null)}}'
                                        ...
                                        @isset($category)
                                            <div class="col-xl-4">
                                                <div class="form-group">
                                                    <label for="">CSS Класс для категории (рекомендуется чтобы совпадал
                                                        с URL)</label>
                                                    <input type="text"
                                                           class="form-control @error('class_category') is-invalid @enderror"
                                                           name="class_category"
                                                           value='{{old('class_category', isset($category)? $category->class_category: null)}}'
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control editor"
                                                          name="anons">{{old('anons', isset($category)? $category->anons: null)}}</textarea>
                                            </div>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows='12'
                                                          ...
                                                          name="description">{{old('description', isset($category)? $category->description: null)}}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id='codemirror' class="form-control editor-html" name="html">{{old('html', isset($category)? $category->html: null)}}</textarea>
                                            </div>
                                        </div>
